...
class JobDispatchServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_JobDispatchServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'JobDispatch', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('JobDispatch', rpc_method_handlers)
